...
![release](https://github.com/odoo4a/odoo-mobile-framework/actions/workflows/release.yml/badge.svg)
![develop](https://github.com/odoo4a/odoo-mobile-framework/actions/workflows/develop.yml/badge.svg?branch=develop)
...
Now a days mobiles are not used just for making calls but they have innumerable uses and can be used as a Camera , Music player, Tablet PC, T.V. , Web browser etc.
And with the new technologies, new software and operating systems are required.
