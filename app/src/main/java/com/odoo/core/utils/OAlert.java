...
public class OAlert {
    ...
    public static void showWarning(
            Context context, String message, OnAlertDismissListener listener) {
    ...
    private static void show(
            Context context, String message, Type type, final OnAlertDismissListener listener) {
    ...
    public static void showConfirm(
            Context context, String message, final OnAlertConfirmListener listener) {
    ...
    public static void inputDialog(
            Context context, String title, final OnUserInputListener listener) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
