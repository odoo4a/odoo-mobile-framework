...
public class OdooUserLoginSelectorDialog implements AdapterView.OnItemClickListener {
    ...
    public OdooUserLoginSelectorDialog(Context context) {
        ...
        mAdapter =
                new ArrayAdapter<OUser>(mContext, R.layout.base_instance_item, accounts) {
                    @Override
                    public View getView(int position, View convertView, ViewGroup parent) {
                        if (convertView == null)
                            convertView =
                                    LayoutInflater.from(mContext)
                                            .inflate(R.layout.base_instance_item, parent, false);
        ...
        if (accounts.size() > 1) mGrid.setNumColumns(2);
    ...
    public void show() {
        ...
        builder.setPositiveButton(
                OResource.string(mContext, R.string.label_drawer_account_add_account),
        ...
        builder.setNegativeButton(
                OResource.string(mContext, R.string.label_cancel),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (mIUserLoginSelectListener != null) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (mIUserLoginSelectListener != null) {
            ...
            askPassword.setOnUserPasswordValidateListener(
                    new OdooUserAskPassword.OnUserPasswordValidateListener() {
                        ...
                        public void onFail() {
                            OAlert.showError(
                                    mContext,
                                    OResource.string(mContext, R.string.error_invalid_password),
                                    new OAlert.OnAlertDismissListener() {
                                        @Override
