...
public class About extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String versionCodeName =
                    packageManager.getPackageInfo(getPackageName(), 0).versionCode + "";
            versionName.setText(getResources().getString(R.string.label_version) + " " + version);
            versionCode.setText(
                    getResources().getString(R.string.label_version_build) + " " + versionCodeName);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == android.R.id.home) {
            finish();
            return true;
        } else if (itemId == R.id.menu_about_our_apps) {
            IntentUtils.openURLInBrowser(this, OConstants.URL_ODOO_APPS_ON_PLAY_STORE);
            return true;
        } else if (itemId == R.id.menu_about_github) {
