...
public class OdooUserAskPassword {
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(password)) {
                            Toast.makeText(
                                            mContext,
                                            R.string.error_provide_password,
                                            Toast.LENGTH_LONG)
                                    .show();
                            show();
                        } else {
    ...
    private View getView() {
        View view =
                LayoutInflater.from(mContext).inflate(R.layout.base_account_ask_pass, null, false);
    ...
    public OdooUserAskPassword setOnUserPasswordValidateListener(
            OnUserPasswordValidateListener listener) {
