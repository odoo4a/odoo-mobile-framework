...
public class IrModel extends OModel {
    ...
    OColumn last_synced = new OColumn("Last Synced on ", ODateTime.class).setLocalColumn();
    ...
    public void setLastSyncDateTimeToNow(OModel model) {
        ...
        Date last_sync =
                ODateUtils.createDateObject(
                        ODateUtils.getUTCDate(), ODateUtils.DEFAULT_FORMAT, true);
