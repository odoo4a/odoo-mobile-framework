...
public final class GsonBuilder {
     ...
     *
     * <p>The date format will be used to serialize and deserialize {@link Date}, {@link Timestamp}
     * and {@link java.sql.Date}.
     *
     ...
     * DateFormat} class. See the documentation in {@link DateFormat} for more information on the
     * valid style constants.
     *
     ...
     * hierarchy. This method combines the registration of a {@link TypeAdapter}, {@link
     * JsonSerializer} and a {@link JsonDeserializer}. If a type adapter was previously registered
     * for the specified type hierarchy, it is overridden. If a type adapter is registered for a
     * specific type in the type hierarchy, it will be invoked instead of the one registered for the
     * type hierarchy.
     *
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class<?> baseType, Object typeAdapter) {
        ...
        if (typeAdapter instanceof JsonDeserializer || typeAdapter instanceof JsonSerializer) {
            hierarchyFactories.add(
                    0, TreeTypeAdapter.newTypeHierarchyFactory(baseType, typeAdapter));
        }
        if (typeAdapter instanceof TypeAdapter<?>) {
            factories.add(
     ...
     * Double#NaN}, {@link Double#POSITIVE_INFINITY}, {@link Double#NEGATIVE_INFINITY}, it will
     * throw an {@link IllegalArgumentException}. This method provides a way to override the default
    ...
    private void addTypeAdaptersForDate(
        ...
        factories.add(
                TreeTypeAdapter.newFactory(TypeToken.get(java.sql.Date.class), dateTypeAdapter));
    }
}
