...
public class JsonReader implements Closeable {
     ...
     *   <li>Top-level values of any type. With strict parsing, the top-level value must be an
     *       object or an array.
            ...
            switch (c) {
                ...
                default:
                    ...
                    if (last == NUMBER_CHAR_SIGN || last == NUMBER_CHAR_NONE) {
                        ...
                        if (value == 0) {
                            return PEEKED_NONE; // Leading '0' prefix is not allowed (since it could
                            // be octal).
                        }
     ...
     * next token is a string, this method will attempt to parse it as a double using {@link
    ...
    /**
     * Returns a <a href="http://goessner.net/articles/JsonPath/">JsonPath</a> to the current
