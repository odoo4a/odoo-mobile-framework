...
public final class Gson {
     ...
     *       {@link BigDecimal}, and {@link BigInteger} classes. If you would prefer to change the
     *       default representation, you can do so by registering a type adapter through {@link
     *       GsonBuilder#registerTypeAdapter(Type, Object)}.
     *   <li>The default Date format is same as {@link java.text.DateFormat#DEFAULT}. This format
     *       ignores the millisecond portion of the date during serialization. You can change this
     *       by invoking {@link GsonBuilder#setDateFormat(int)} or {@link
     ...
     *   <li>The default field naming policy for the output Json is same as in Java. So, a Java
     *       class field <code>versionNumber</code> will be output as <code>
     *       &quot;versionNumber&quot;</code> in Json. The same rules are applied for mapping
     *       incoming Json to the Java classes. You can change this policy through {@link
     *       GsonBuilder#setFieldNamingPolicy(FieldNamingPolicy)}.
     *   <li>By default, Gson excludes <code>transient</code> or <code>static</code> fields from
     *       consideration for serialization and deserialization. You can change this behavior
     *       through {@link GsonBuilder#excludeFieldsWithModifiers(int...)}.
     * </ul>
     */
    public Gson() {
        this(
    ...
    Gson(
        ...
        factories.add(
                TypeAdapters.newFactory(
                        long.class, Long.class, longAdapter(longSerializationPolicy)));
        factories.add(
                TypeAdapters.newFactory(
                        double.class,
                        Double.class,
        ...
        factories.add(
                new MapTypeAdapterFactory(constructorConstructor, complexMapKeySerialization));
     ...
     * from or written to JSON. We can achieve this by writing a type adapter factory that uses the
     * <code>
     ...
     * itself should not be of a generic type. If the object is of generic type, use {@link
     * #toJson(Object, Type)} instead. If you want to write out the object to a {@link Writer}, use
     ...
     * a generic type. For the cases when the object is of generic type, invoke {@link
     * #fromJson(String, Type)}. If you have the Json in a {@link Reader} instead of a String, use
     ...
     *     deserialized
     * @param classOfT The class of T
     * @return an object of type T from the json. Returns {@code null} if {@code json} is {@code
     *     null}.
     * @throws JsonSyntaxException if json is not a valid representation for an object of type
     *     typeOfT
     * @since 1.3
